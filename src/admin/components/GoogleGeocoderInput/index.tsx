  ...
  <ModalBody>
    <div style={{ height: '50vh', width: '100%' }}>
      <GoogleMapReact
        ...
        defaultCenter={{ lat: modifiedData[attribute.latitude_field_name], lng: modifiedData[attribute.longitude_field_name] }}
        defaultZoom={ 17 }
      >
        <Marker lat={modifiedData[attribute.latitude_field_name]} lng={modifiedData[attribute.longitude_field_name]} />
      </GoogleMapReact>
    </div>
  </ModalBody>
</ModalLayout>
...
{/* value != '' &&
<Link onClick={(e) => { e.preventDefault(); setIsVisible(prev => !prev) }} href={`https://www.google.com/maps/search/?api=1&query=${value}`}>
    Show on map
</Link>
*/ }
...
GoogleGeocoderInput.defaultProps = {
    description: null,
    disabled: false,
    error: null,
    labelAction: null,
